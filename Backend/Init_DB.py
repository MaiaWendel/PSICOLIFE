...
with app.app_context():
    ...
    psicologos = [
        {'nome': 'Dra. Ana Silva', 'email': 'ana.silva@psicolife.com', 'usuario': 'ana.silva'},
        {'nome': 'Dr. Carlos Mendes', 'email': 'carlos.mendes@psicolife.com', 'usuario': 'carlos.mendes'},
        {'nome': 'Dra. Juliana Alves', 'email': 'juliana.alves@psicolife.com', 'usuario': 'juliana.alves'},
        {'nome': 'Dr. Ricardo Santos', 'email': 'ricardo.santos@psicolife.com', 'usuario': 'ricardo.santos'}
    ]
    ...
    print('Psicólogos: [nome]@psicolife.com / psicologo123')